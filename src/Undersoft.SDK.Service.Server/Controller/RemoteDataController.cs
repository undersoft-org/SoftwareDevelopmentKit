...
[Area("Data")]
[RemoteDataOperator]
public abstract class RemoteDataController<TKey, TStore, TDto, TModel, TService>
    : RemoteServiceController<TStore, TService, TDto>,
        IRemoteDataController<TKey, TDto, TModel>
    ...
    where TService : class
{
    ...
    protected readonly PublishMode _publishMode = PublishMode.Propagate;
    ...
    public virtual async Task<IActionResult> Patch([FromBody] TModel[] dtos)
    {
        ...
        return await ExecuteSet(new RemoteChangeSet<TStore, TDto, TModel>(_publishMode, dtos, _predicate));
    }
    ...
    public virtual async Task<IActionResult> Put([FromBody] TModel[] dtos)
    {
        ...
        return await ExecuteSet(new RemoteUpdateSet<TStore, TDto, TModel>(_publishMode, dtos, _predicate));
    }
