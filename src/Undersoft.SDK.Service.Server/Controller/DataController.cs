...
[Area("Data")]
[DataOperator]
public abstract class DataController<TKey, TStore, TEntity, TDto, TService>
    : ServiceController<TStore, TService, TDto>,
        IDataController<TKey, TEntity, TDto>
    ...
    where TService : class
{
    ...
    protected PublishMode _publishMode = PublishMode.Propagate;

    public DataController() { }

    public DataController(IServicer servicer)
        : base(servicer) { }
