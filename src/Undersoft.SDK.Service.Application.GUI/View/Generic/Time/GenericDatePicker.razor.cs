...
public partial class GenericDatePicker : FluentCalendarBase
{
    ...
    /// <summary>
    /// Gets or sets a value which will be set when double-clicking on the text
