...
namespace Undersoft.SDK.Service.Application.GUI.View.Generic.Time;
...
internal struct CalendarExtended
{
    ...
    /// <summary>
    /// Returns the name of the month in the right culture, followed by the
    /// year.
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// Returns a list of days, abbreviated and complete (Mon, Monday),
    /// ...,(Sun, Sunday) in the correct culture.
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// Returns True if the specified date is in the current month of the
    /// <see cref="Date"/>.
    /// </summary>
    /// <param name="date"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Returns the string in title case (the first letter of a word is an
    /// uppercase letter).
    /// </summary>
