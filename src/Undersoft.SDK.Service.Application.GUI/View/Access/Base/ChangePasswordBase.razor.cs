...
/// </summary>
public partial class ChangePasswordBase<TLogo, TAccount> : ComponentBase where TAccount : class, IAuthorization, new() where TLogo : Icon, new()
{
    /// <summary>
    ...
    private async Task<IAuthorization?> HandleDialog(IViewData<Credentials>? content)
    {
        ...
        var result = await _access.ChangePassword(new TAccount() { Credentials = content!.Model });
